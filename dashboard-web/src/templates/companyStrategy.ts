...
export const companyStrategyTemplate = finalizeTemplate({
  ...
  requiredDatasets: ["metrics", "recommendations"], optionalDatasets: ["time_series", "segments", "matrices", "risks", "initiatives", "scenarios"],
  ...
  pages: [
    ...
    { id: "execution-roadmap", label: "情景与执行", purpose: "明确情景触发条件、行动、责任和里程碑。", widgets: [widget("scenarios", "ScenarioChart", "战略情景", "scenarios", 1), widget("roadmap", "InitiativeRoadmap", "行动组合", "initiatives", 2, true)] },
  ],
});
